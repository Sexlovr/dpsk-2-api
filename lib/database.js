...
export async function initDB() {
    ...
    // Seed default models
    const cnt = db.exec("SELECT COUNT(*) as c FROM models");
    if (cnt.length && cnt[0].values[0][0] === 0) {
        db.run("INSERT INTO models (model_id, display_name) VALUES ('deepseek_chat', 'DeepSeek V3')");
        db.run("INSERT INTO models (model_id, display_name) VALUES ('deepseek_r1', 'DeepSeek R1')");
    }
